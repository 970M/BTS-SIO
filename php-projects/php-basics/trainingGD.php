...
include_once("trainningGD.inc.php");
echo 'Nous sommes toujours dans le fichier entrainement<br>';
...
# GET
echo '<h1> GET </h1>';
echo '<form action="trainingGD_server.php" method="get">';
...
# POST
echo '<h1> POST </h1>';
echo '<form action="trainingGD_server.php" method="post">';
echo 'Votre nom : <input type="text" name="nom"><br />';
echo 'Votre fonction : <input type="text" name="fonction"><br />';
echo ' <input type="submit" value="Envoyer">';
echo '</form>';
...
# EMAIL
///mail("from@gmail.com", "test mail php", "Le message voila", "to@gmail.com");
